...
from .lbs import (lbs, blend_shapes, find_dynamic_lmk_idx_and_bcoords, vertices2landmarks)

from .vertex_ids import vertex_ids as VERTEX_IDS
from .utils import (
    Struct, to_np, to_tensor, Tensor, Array, find_joint_kin_chain,
...
class SMPLX(SMPLH):
    ...
    def forward(
        ...
        **kwargs
        ...
        vertices, joints, A, T, shape_offsets, pose_offsets = lbs(shape_components, full_pose, self.v_template,
